          ...
          <br />
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" value="{{ $dataset->name }}" id="name" name="name" required="required" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" value="{{ $dataset->zone }}" id="zone" name="zone" required="required" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
