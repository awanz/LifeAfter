          ...
          <br />
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input autocomplete="off" type="text" value="{{ $dataset[0]->title }}" id="title" name="title" required="required" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input autocomplete="off" type="text" value="{{ $dataset[0]->descriptions }}" id="descriptions" name="descriptions" required="required" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
