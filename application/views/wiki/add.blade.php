        ...
        <div class="x_content">
          ...
          <div class="form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
              <input type="text" id="title" name="title" placeholder="Title" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
              <textarea id="descriptions" name="descriptions" class="resizable_textarea form-control" placeholder="Descriptions.."></textarea>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
              <input type="text" id="keywords" name="keywords" placeholder="Keywords" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          <div class="clearfix"></div><br>
          <div class="ln_solid"></div>
