      ...
      <div class="x_panel">
        ...
        <div class="x_content">
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Title <small><b>*</b></small></label>
            <div class="col-md-9 col-sm-9 col-xs-12">
              <input type="text" value="{{ $dataset->title }}" id="title" name="title" placeholder="Title" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <textarea id="content" name="content" style="display:none;">{{ $dataset->content }}</textarea>
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Descriptions</label>
            <div class="col-md-9 col-sm-9 col-xs-12">
              <textarea id="descriptions" name="descriptions" class="resizable_textarea form-control" placeholder="Descriptions..">{{ $dataset->descriptions }}</textarea>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
              <input type="text" value="{{ $dataset->keywords }}" id="keywords" name="keywords" placeholder="Keywords" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          <div class="clearfix"></div><br>
          <div class="ln_solid"></div>
