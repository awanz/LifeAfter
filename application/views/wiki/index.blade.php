            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td style="width: 20%;">
                      ...
                      @if ($data->status == 1)
                      <a href="{{ base_url($CI->uri->segment(1).'/'.$data->id.'/status/0') }}"><button type="button" class="btn btn-danger">Draft</button></a>
                      @else
                      <a href="{{ base_url($CI->uri->segment(1).'/'.$data->id.'/status/1') }}"><button type="button" class="btn btn-info">Publish</button></a>
                      @endif
                  </td>
              </tr>
              @php
